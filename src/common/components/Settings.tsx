            ...
            >
                <div>
                    ...
                    >
                        ...
                        <div style={{ display: values.provider === 'Dify' ? 'block' : 'none' }}>
                            <FormItem
                                name='difyAPIKey'
                                label={t('Dify API Key')}
                                required={values.provider === 'Dify'}
                            >
                                <Input
                                    size='compact'
                                    type='password'
                                    placeholder={t('Enter your Dify API Key')}
                                />
                            </FormItem>
                            ...
                            <FormItem
                                name='difyAPIURL'
                                label={t('API URL')}
                                caption={t('Optional, defaults to https://api.dify.ai')}
                            >
                                <Input
                                    size='compact'
